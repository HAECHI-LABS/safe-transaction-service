...
TASKS = [
    ...
    CeleryTaskConfiguration(
        ...
        interval=settings.INDEX_INTERNAL_TXS_TASK_INTERVAL if settings.INDEX_INTERNAL_TXS_TASK_INTERVAL else 5,
    ...
    CeleryTaskConfiguration(
        ...
        interval=settings.INDEX_SAFE_EVENTS_TASK_INTERVAL if settings.INDEX_SAFE_EVENTS_TASK_INTERVAL else 5,
        period=IntervalSchedule.SECONDS,
    ...
    CeleryTaskConfiguration(
        ...
        interval=settings.INDEX_NEW_PROXIES_TASK_INTERVAL if settings.INDEX_NEW_PROXIES_TASK_INTERVAL else 4,
        period=IntervalSchedule.SECONDS,
        enabled=settings.ETH_L2_NETWORK,
    ),
    CeleryTaskConfiguration(
